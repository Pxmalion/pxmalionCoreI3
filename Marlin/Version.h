...
#define SHORT_BUILD_VERSION "1.5.2"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2017-12-6 00:20"
   ...
   */
  #define MACHINE_NAME "PXMALION-P1"
   ...
   */
  #define WEBSITE_URL "http://www.pxmalion.com/"
