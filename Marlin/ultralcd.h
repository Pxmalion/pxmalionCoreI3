...
enum USER_CMD_T{
	USER_CMD_NONE,
/* 配置命令*/
	USER_CMD_CONFIG_LOAD,
	USER_CMD_CONFIG_LOADING,
	USER_CMD_CONFIG_LOAD_DONE,	
	USER_CMD_CONFIG_UNLOAD,
	USER_CMD_CONFIG_UNLOAD_INSERT,
	USER_CMD_CONFIG_UNLOADING,
	USER_CMD_CONFIG_UNLOAD_DONE,
	
/*factory test*/
/* z-axis adjust*/
	USER_CMD_TEST_ADJUSTING_Z_HOME,
	USER_CMD_TEST_ADJUSTING_Z_DONE,
