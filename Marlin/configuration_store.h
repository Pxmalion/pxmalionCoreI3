...
class MarlinSettings {
  public:
	...
	static void file_runout_init();
	static bool load_file_runout_state();
	static void store_file_runout_state_no_save(char new_flag);
	static void store_file_runout_state(char new_flag);
#endif
...
#ifdef EEPROM_CUSTOM_FIL_FLAG
	static bool file_runout_detect;
#endif
